  ...
  if (active) {
    ...
    if (active.userEdited && active.seedVersion !== SEED_VERSION) {
      ...
      const refreshed: Plan = {
        ...
        spuntinoMattinaAllenamento: active.spuntinoMattinaAllenamento ?? scaled.spuntinoMattinaAllenamento,
    ...
    if (!active.userEdited) {
      const refreshed: Plan = {
        ...
        spuntinoMattinaAllenamento: def.spuntinoMattinaAllenamento,
